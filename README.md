...
<!-- Progress: 132/401 tasks completed -->
...
| [task063.py](task063.py) | ✅ Completed | 124 | Max | |
...
| [task271.py](task271.py) | ✅📚 Completed | 130 | Max | |
...
| [task337.py](task337.py) | ✅ Completed | 52 | Ghi, Max | {x:x,...}[x] == {...}.get(x,x), but you gain 2 bytes |
...
| [task351.py](task351.py) | ✅ Completed | 136 | Max | |
